...
public class AntiPacman extends JPanel {
  ...
  public void drawSquares() {
    ...
    try {
	    ...
	    drawPacmen(thePacmen[0], pacOneImg);
	    drawPacmen(thePacmen[1], pacTwoImg);
	    drawPacmen(thePacmen[2], pacThreeImg);
	    drawPacmen(thePacmen[3], pacFourImg);
  ...
  // Update board location with that enemy type
